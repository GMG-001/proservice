...
<section class="section_1">
    <div class="border_1">
        <div class="z-index container">
            ...
            <div class="section__list auth_regis">
        ...
        <div class="reservation">
            ...
            <div class="reservation_inputs">
                ...
                <!-- <input type="date" class="data data_placeholder" id="date"> -->
                <input type="text" placeholder="Check-in date" class="data data_placeholder" id="date" onfocus="(this.type='date')">

                <label class="reserv__text" for="Check-out">Check-out date</label>
                <input type="text" placeholder="Check-in date" class="data data_placeholder1" id="date" onfocus="(this.type='date')">
                <!-- <input type="date" class="data data_placeholder1" id="date1"> -->

                <label class="reserv__text" for="Check-in">ზრდასრული</label>
                <input type="number" class="data" min="1" placeholder="ადამიანი">
                <label class="reserv__text sm_in_lb" for="data">ბავშვები</label>
                <label class="reserv__text" for="Check-in">ოთახი</label>
                <input class="inline__input" type="number" min="0" placeholder="ბავშვები">
                <input  class="inline__input" type="number" min="1" placeholder="ოთახი">
...
<section class="section_2">
    ...
    <div class="contact">
        <div id="carouselExampleFade" class="carousel slide carousel-fade" data-bs-ride="carousel">
            <div class="carousel-item active">
                <p class="slider_text">
                    დაგვიკავშირდით ნომერზე (995dfdfdf) 599 55 64 64 ან მოგვწერეთ info@martini.ge
                </p>
            </div>
            <div class="carousel-item">
                <p class="slider_text">
                    დაგვიკავშირდით ნომერზე (99df235) 599 55 64 64 ან მოგვწერეთ info@martini.ge
                </p>
            </div>
            <div class="carousel-item">
                <p class="slider_text">
        ...
        <div class="container slider_button_div">
            <button class="slider_button" type="button" data-bs-target="#carouselExampleFade" data-bs-slide="prev">
                <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                <span class="visually-hidden">Previous</span>
            </button>
            <button class="slider_button" type="button" data-bs-target="#carouselExampleFade" data-bs-slide="next">
